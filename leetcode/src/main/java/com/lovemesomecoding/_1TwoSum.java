...
public class _1TwoSum {
	...
	public static void main(String[] args) {
		...
		int[] nums = { 2, 67, 4, 3, 23 };

		int[] twoOperands = twoSumWithBruteForce(nums, target);

		System.out.println(Arrays.toString(twoOperands));

		twoOperands = twoSumWithTwoPassHashMap(nums, target);

		System.out.println(Arrays.toString(twoOperands));

		twoOperands = twoSumWithOnePassHashMap(nums, target);
	 ...
	 * there is another value that equals to target - xtarget−x.
	 * 
	 * Complexity Analysis
	 * 
	 ...
	 */
	public static int[] twoSumWithTwoPassHashMap(int[] nums, int target) {
